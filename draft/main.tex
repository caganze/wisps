...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{\figfolder mass_hubble_colors.pdf}
    \includegraphics[width=\textwidth]{\figfolder hst_relations.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.6]{\figfolder simulation_distances.pdf}
...
\begin{figure}
\centering
\gridline{\fig{\figfolder simulation_volumes.pdf}{0.6 \textwidth}{(a)}}
\gridline{\fig{\figfolder cumulative_volumes.pdf}{0.6 \textwidth}{(b)}}
...
\begin{figure}
    \centering
    \gridline{\fig{\figfolder mag_limits_all.pdf}{0.9 \textwidth}{(a)}}
    \gridline{\fig{\figfolder mag_limits_illustration.pdf}{0.9\textwidth}{(b)}}
    \gridline{\fig{\figfolder mag_limit.pdf}{0.9\textwidth}{(c)}}
