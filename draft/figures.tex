...
\begin{figure*}
  \centering
    \gridline{
    \fig{\figfolder confusion_matrix.pdf}{0.5\textwidth}{(a)}
    \fig{\figfolder cv_scores.pdf}{0.5\textwidth}{(b)}
    }
    \caption{(a) Confusion matrix for the random forest classifier used in this survey (b) CV scores for the number of features used}
    \label{fig:matrix}
...
\begin{figure*}
    \centering
    \includegraphics[scale=0.35]{\figfolder candidates.pdf}
